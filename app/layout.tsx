      ...
      >
        ...
        >
          <main className="relative flex flex-col justify-center h-full ">
            ...
            <div
              id="gradient"
              className="absolute inset-0 object-cover bg-gradient-to-b dark:bg-gradient-to-b dark:from-background dark:to-current from-yellow-300 to-green-300 opacity-70 dark:opacity-30"
            ></div>
